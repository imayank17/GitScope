...
@pytest.mark.anyio
async def test_sync_repository_success(sync_service, respx_mock_github, db_repository, db):
    """
    ...
    respx_mock_github["get_repo"].mock(
        return_value=Response(200, json={
            ...
            "owner": {"login": repo.owner_login, "avatar_url": repo.owner_avatar_url},
    ...
    respx_mock_github["get_contributors"].mock(
        return_value=Response(200, json=[
            ...
            {"id": 901, "login": "user-alice", "avatar_url": "https://...", "html_url": "https://...", "contributions": 150},
            # Add a brand new contributor
            {"id": 903, "login": "user-charlie", "avatar_url": "https://...", "html_url": "https://...", "contributions": 10}
        ])
    )
    ...
    respx_mock_github["get_commits"].mock(
        return_value=Response(200, json=[
            # Existing commit
            {
                ...
                "commit": {"message": "xyz", "author": {"name": "a", "email": "e", "date": "2026-07-01T10:00:00Z"}, "committer": {"name": "c"}},
                "html_url": "http://..."
            },
            # New commit
            {
                "sha": "newcommitsha12345678901234567890123456",
                "commit": {"message": "Fix bug", "author": {"name": "Bob", "email": "b", "date": "2026-07-05T10:00:00Z"}, "committer": {"name": "Bob"}},
                "html_url": "http://..."
            }
        ])
    )
...
@pytest.mark.anyio
async def test_sync_repository_task_success(sync_service, respx_mock_github, db_repository, db):
    """
    ...
    respx_mock_github["get_repo"].mock(
        return_value=Response(200, json={
            ...
            "owner": {"login": db_repository.owner_login, "avatar_url": db_repository.owner_avatar_url},
...
@pytest.mark.anyio
async def test_sync_repository_task_failure(sync_service, respx_mock_github, db_repository, db):
    """
...
@pytest.mark.anyio
async def test_sync_repository_partial_failures(sync_service, respx_mock_github, db_repository, db):
    """
...
@pytest.mark.anyio
async def test_sync_repository_upsert_existing(sync_service, respx_mock_github, db_repository, db):
    """
...
@pytest.mark.anyio
async def test_sync_repository_task_db_commit_error(sync_service, respx_mock_github, db_repository, monkeypatch):
    """
